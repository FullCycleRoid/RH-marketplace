...
from src.auth.enums import AuthProvider, ActiveState, CreationMethod
...
class User(Base):
    ...
    active_state = Column(Enum(ActiveState, name="activestate", create_type=True), nullable=False, default=ActiveState.WAIT_FOR_VERIFICATION)
    creation_method = Column(Enum(CreationMethod, name="creationmethod", create_type=True), nullable=False, default=CreationMethod.REGISTERED)
