from src.company.models import Company, Manager
from uuid import uuid4
from datetime import datetime
from sqlalchemy.orm import Session
from src.company.enums import LegalStatus, SystemStatus, ContactType, ManagerType, ReportStatus, FieldType
...
class CompanyBuilder:
    ...
    def set_legal_fields(self, legal_name, legal_address, inn, kpp, ogrn, registration_date):
        self.company.add_legal_field('legal_name', legal_name, FieldType.STRING, required=True)
        self.company.add_legal_field('legal_address', legal_address, FieldType.STRING, required=True)
        ...
        self.company.add_legal_field('registration_date', registration_date.isoformat(), FieldType.DATE, required=True)
        return self
    ...
    def set_managers(self, managers):
        for manager in managers:
            self.company.managers.append(Manager(
                id=uuid4(),
...
data = {
    ...
    'financial_reports': [
        FinancialReport(year='2023', annual_income=90100000, net_profit=8199999, currency='RUB')
    ],
    'tax_reports': [
        TaxReport(year='2023', taxes_paid=2600000, paid_insurance=1800000)
    ]
}
