...
from src import LegalStatus, SystemStatus, Company, CompanyField, CompanyFieldType
...
class FieldTypePostgresRepository:
    ...
    async def get_active_country_requirements(self, country_code: str) -> List[CompanyFieldType]:
